...
import { S as ScrollAnimator, I as IntakeFormModal, $ as $$ClientInsights, a as $$CTA } from '../chunks/ClientInsights_CzhgcSH5.mjs';
import { B as Button } from '../chunks/toaster_Br8Fs97V.mjs';
import 'clsx';
/* empty css                                 */
...
const $$TechnologyStack = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="py-32 lg:py-40"> <div class="max-w-6xl mx-auto px-6 lg:px-20 xl:px-24"> <div class="space-y-12 lg:space-y-20"> <div class="text-left space-y-8 animate-fade-in"> <h2 class="text-4xl md:text-5xl font-light leading-tight tracking-tight text-foreground"> ${title} </h2> <div class="w-12 h-px bg-foreground/20"></div> </div> <div class="grid lg:grid-cols-12 gap-8 lg:gap-20"> <div class="lg:col-span-7"> <div class="space-y-12 animate-fade-in" style="animation-delay: 200ms;"> <div class="prose prose-lg max-w-none"> <p class="text-base sm:text-lg font-light text-foreground leading-relaxed mb-6"> ${description} </p> </div> <div class="space-y-8"> ${technologies.map((tech, index) => renderTemplate`<div class="group animate-fade-in"${addAttribute(`animation-delay: ${400 + index * 150}ms;`, "style")}> <div class="relative p-8 rounded-xl bg-background border border-foreground/10 hover:border-primary/30 transition-all duration-500 hover:neumorphic-hover-card hover:dark:neumorphic-hover-card-dark hover:scale-[1.02] hover:-translate-y-1">  ${index < technologies.length - 1 && renderTemplate`<div class="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-px h-4 bg-gradient-to-b from-primary/30 to-transparent"></div>`} <div class="space-y-8"> <div class="flex items-start justify-between"> <div class="space-y-1"> <div class="text-xs font-light text-primary/70 uppercase tracking-wider">
Intelligence Domain
</div> <h3 class="text-xl font-light text-foreground group-hover:text-primary transition-colors duration-300"> ${tech.category} </h3> </div>  <div class="w-2 h-2 rounded-full bg-primary/30 group-hover:bg-primary/50 transition-colors duration-300 mt-2"></div> </div> <div class="relative"> <div class="absolute left-0 top-0 w-0.5 h-full bg-primary/20"></div> <p class="text-base font-light text-foreground/70 leading-relaxed pl-4"> ${tech.description} </p> </div> </div> </div> </div>`)} </div> </div> </div> <div class="lg:col-span-5">  </div> </div> </div> </div> </section>`;
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  ] })}  <section id="services" class="bg-secondary/20 py-16 sm:py-20 lg:py-24"> <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8"> ${renderComponent($$result2, "ScrollAnimator", ScrollAnimator, { "client:visible": true, "threshold": 0.2, "duration": 1e3, "client:component-hydration": "visible", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/src/components/interactive/ScrollAnimator.tsx", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate` <div class="mx-auto max-w-2xl lg:mx-0"> <h2 class="text-4xl md:text-5xl font-light leading-tight tracking-tight text-foreground">${homePageContent.legacyEcosystemAnalysis.title}</h2> <p class="mt-6 text-lg leading-8 text-muted-foreground"> ${homePageContent.legacyEcosystemAnalysis.description} </p> <h3 class="mt-8 text-xl font-light text-foreground"> ${homePageContent.legacyEcosystemAnalysis.subtitle} </h3> <p class="mt-4 text-lg leading-8 text-muted-foreground"> ${homePageContent.legacyEcosystemAnalysis.description2} </p> <ul class="mt-6 space-y-2 list-disc pl-5 text-lg font-light text-foreground/80 leading-relaxed"> ${homePageContent.legacyEcosystemAnalysis.services.map((service) => renderTemplate`<li>${service.name}</li>`)} </ul> </div> ` })} </div> </section>  <section id="about" class="py-16 sm:py-20 lg:py-24 bg-secondary/20" aria-labelledby="about-heading"> <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8"> <div class="max-w-4xl mx-auto"> <div> ${renderComponent($$result2, "ScrollAnimator", ScrollAnimator, { "client:visible": true, "threshold": 0.2, "duration": 1e3, "client:component-hydration": "visible", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/src/components/interactive/ScrollAnimator.tsx", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate` <div class="space-y-12"> <div class="space-y-8"> <h2 id="about-heading" class="text-4xl md:text-5xl font-light leading-tight tracking-tight text-foreground"> ${homePageContent.foundedStory.companyName} </h2> <div class="w-16 h-px bg-foreground/20"></div> </div> <div class="space-y-6"> <p class="text-lg font-light text-foreground/70 leading-relaxed">
