        ...
        "a",
        {
          ...
          children: /* @__PURE__ */ jsx("div", { className: "bg-background border border-foreground/10 rounded-lg p-8 h-full hover:border-foreground/30 hover:neumorphic-hover-card hover:dark:neumorphic-hover-card-dark transition-all duration-300", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between pt-4 border-t border-foreground/10", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-xs font-light text-foreground group-hover:text-blue-500 transition-colors duration-300", children: "Read Report →" })
            ] })
          ] }) })
        }
      ) }, report.id)) })
...
</p> </div> </div> <!-- Interactive Reports with Search/Filter --> ${renderComponent($$result2, "ReportsFilter", ReportsFilter, { "client:load": true, "reports": reportsData, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/src/components/interactive/ReportsFilter.tsx", "client:component-export": "default" })} </div> <!-- Stats --> <div class="grid grid-cols-3 gap-8 pt-20 mt-20 border-t border-foreground/10"> <div class="text-center space-y-2"> <div class="text-3xl font-light text-foreground">${reportsData.length}</div> <div class="text-sm font-light text-foreground/60 tracking-wider">TOTAL REPORTS</div> </div> <div class="text-center space-y-2"> <div class="text-3xl font-light text-foreground">${categories.length}</div> <div class="text-sm font-light text-foreground/60 tracking-wider">CATEGORIES</div> </div> <div class="text-center space-y-2"> <div class="text-3xl font-light text-foreground">2024</div> <div class="text-sm font-light text-foreground/60 tracking-wider">LATEST YEAR</div> </div> </div> </section> ` })}`;
