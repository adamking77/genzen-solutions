import { c as createAstro, a as createComponent, m as maybeRenderHead, r as renderComponent, n as renderScript, b as addAttribute, d as renderTemplate, u as unescapeHTML } from './astro/server_Co88VAjz.mjs';
import 'kleur/colors';
...
function SimpleThemeToggle() {
  ...
  useEffect(() => {
    ...
    const isDark2 = stored === "dark" || stored === "system" && window.matchMedia("(prefers-color-scheme: dark)").matches || !stored && window.matchMedia("(prefers-color-scheme: dark)").matches;
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      className: `relative inline-flex items-center justify-center w-[50px] h-[26px] rounded-full p-0.5 transition-colors duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background ${isDark ? "bg-slate-700" : "bg-slate-200"}`,
      children: [
        ...
        /* @__PURE__ */ jsx(
          ...
          {
            "aria-hidden": "true",
            className: `absolute left-[4px] transition-opacity duration-300 ease-in-out ${isDark ? "opacity-50" : "opacity-100"}`,
        ...
        /* @__PURE__ */ jsx(
          ...
          {
            "aria-hidden": "true",
            className: `absolute right-[4px] transition-opacity duration-300 ease-in-out ${isDark ? "opacity-100" : "opacity-50"}`,
        ...
        /* @__PURE__ */ jsx(
          ...
          {
            "aria-hidden": "true",
            className: `pointer-events-none inline-block w-[20px] h-[20px] transform rounded-full bg-white shadow-lg ring-0 transition-transform duration-300 ease-in-out ${isDark ? "translate-x-[12px]" : "translate-x-[-12px]"}`
          }
        )
      ]
    }
...
export { $$Footer as $, Button as B, ScrollToTop as S, Toaster as T, $$Navigation as a, cn as c };
