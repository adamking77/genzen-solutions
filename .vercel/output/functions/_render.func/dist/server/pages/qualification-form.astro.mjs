/* empty css                                 */
import { c as createAstro, a as createComponent, b as renderTemplate, r as renderComponent, e as renderHead, d as addAttribute, f as renderSlot, m as maybeRenderHead } from '../chunks/astro/server_iUh9UfrQ.mjs';
import 'kleur/colors';
/* empty css                                 */
import { T as ThemeProvider, $ as $$Navigation, b as Toaster, S as ScrollToTop, a as $$Footer } from '../chunks/toaster_C0KPcJBy.mjs';
...
}, "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/layouts/FormLayout.astro", void 0);

const $$QualificationForm = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "FormLayout", $$FormLayout, { "title": "Legacy Ecosystem Analysis Application" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="p-4"> ${renderComponent($$result2, "GZSIntakeForm", GZSIntakeForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/interactive/GZSIntakeForm", "client:component-export": "default" })} </div> ` })}`;
}, "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/pages/qualification-form.astro", void 0);

const $$file = "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/pages/qualification-form.astro";
