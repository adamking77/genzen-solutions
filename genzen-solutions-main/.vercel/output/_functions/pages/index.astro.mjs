/* empty css                                 */
import { c as createAstro, a as createComponent, m as maybeRenderHead, r as renderComponent, b as renderTemplate, d as addAttribute, u as unescapeHTML, j as renderScript } from '../chunks/astro/server_iUh9UfrQ.mjs';
import 'kleur/colors';
...
import { G as GZSIntakeForm } from '../chunks/GZSIntakeForm_BYc81A0A.mjs';
import { B as Button } from '../chunks/toaster_C0KPcJBy.mjs';
import 'clsx';
/* empty css                                 */
...
const $$Astro$6 = createAstro("https://genzen-solutions.com");
const $$CompanyHero = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="company-hero-section pt-32 pb-24 sm:pt-40 sm:pb-32 lg:pt-48 lg:pb-40 bg-background text-foreground"> <div class="max-w-6xl mx-auto px-6 lg:px-8"> <div class="space-y-8 sm:space-y-10 lg:space-y-12"> <div> ${renderComponent($$result, "ScrollAnimator", ScrollAnimator, { "client:load": true, "threshold": 0.2, "duration": 1e3, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/interactive/ScrollAnimator.tsx", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` <h1 class="text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-light leading-tight tracking-tight max-w-5xl text-foreground"> ${title} <span class="text-foreground/50">${location}</span> </h1> ` })} </div> ${subtitle && renderTemplate`<div> ${renderComponent($$result, "ScrollAnimator", ScrollAnimator, { "client:load": true, "threshold": 0.2, "duration": 1e3, "delay": 200, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/interactive/ScrollAnimator.tsx", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` <p class="text-base sm:text-lg md:text-xl font-light text-foreground/70 leading-relaxed max-w-2xl"> ${subtitle} </p> ` })} </div>`} <div> ${renderComponent($$result, "ScrollAnimator", ScrollAnimator, { "client:load": true, "threshold": 0.2, "duration": 1e3, "delay": 400, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/interactive/ScrollAnimator.tsx", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "IntakeFormModal", IntakeFormModal, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/modals/IntakeFormModal.tsx", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Button", Button, { "size": "lg", "className": "font-light text-base px-12 py-3 h-auto border-2 border-foreground/20 bg-transparent text-foreground hover:border-primary hover:bg-primary hover:text-primary-foreground hover:scale-105 transition-[border-color,background-color,color,transform] duration-300 ease-in-out rounded-full" }, { "default": ($$result4) => renderTemplate`${ctaText}` })} ` })} ` })} </div> </div> </div> </section>`;
}, "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/layouts/CompanyHero.astro", void 0);
...
const $$PerformanceMetrics = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="py-16 sm:py-20 lg:py-24 bg-secondary/30" id="performance-metrics-section"> <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8"> <div class="grid lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12"> <div class="lg:col-span-5"> ${renderComponent($$result, "ScrollAnimator", ScrollAnimator, { "client:load": true, "threshold": 0.2, "duration": 1e3, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/interactive/ScrollAnimator.tsx", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` <div class="space-y-8 sticky top-32"> <h2 class="text-4xl md:text-5xl font-light leading-tight tracking-tight text-foreground"> ${title} </h2> <div class="w-12 h-px bg-foreground/20"></div> ${subtitle && renderTemplate`<p class="text-sm sm:text-base font-light text-foreground leading-relaxed"> ${subtitle} </p>`} ${description && renderTemplate`<p class="text-sm sm:text-base font-light text-foreground leading-relaxed"> ${description} </p>`} </div> ` })} </div> <div class="lg:col-span-7"> ${renderComponent($$result, "ScrollAnimator", ScrollAnimator, { "client:load": true, "threshold": 0.2, "duration": 1e3, "delay": 200, "staggerChildren": 150, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/interactive/ScrollAnimator.tsx", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` <div class="grid grid-cols-1 gap-6 sm:grid-cols-3 sm:grid-rows-2 sm:gap-8 lg:gap-12"> ${metrics.map((metric, index) => {
...
}, "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/reports/PerformanceMetrics.astro", void 0);
...
}, "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/reports/ClientInsights.astro", void 0);
...
}, "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/reports/TechnologyStack.astro", void 0);
...
const $$CTA = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="py-16 sm:py-20 lg:py-24"${addAttribute(sectionId, "id")}> <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8"> <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12"> <div class="col-span-12 lg:col-span-5"> ${renderComponent($$result, "ScrollAnimator", ScrollAnimator, { "client:load": true, "threshold": 0.2, "duration": 1e3, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/interactive/ScrollAnimator.tsx", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` <div class="space-y-8"> ${headline && renderTemplate`<h2 class="text-4xl md:text-5xl font-light leading-tight tracking-tight text-foreground"> ${headline} </h2>`} ${leftText && renderTemplate`<p class="text-lg font-light text-foreground/70 leading-relaxed"> ${leftText} </p>`} </div> ` })} </div> <div class="col-span-12 lg:col-span-6 lg:col-start-7"> ${renderComponent($$result, "ScrollAnimator", ScrollAnimator, { "client:load": true, "threshold": 0.2, "duration": 1e3, "delay": 200, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/interactive/ScrollAnimator.tsx", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` <div class="space-y-8"> ${rightText && rightText.map((paragraph) => renderTemplate`<p class="text-lg font-light text-foreground/70 leading-relaxed"> ${paragraph} </p>`)} ${buttonText && renderTemplate`<div> ${renderComponent($$result2, "IntakeFormModal", IntakeFormModal, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/modals/IntakeFormModal.tsx", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Button", Button, { "size": "lg", "className": "font-light text-base px-12 py-3 h-auto border-2 border-foreground/20 bg-transparent text-foreground hover:border-primary hover:bg-primary hover:text-primary-foreground hover:scale-105 transition-[border-color,background-color,color,transform] duration-300 ease-in-out rounded-full" }, { "default": ($$result4) => renderTemplate`${buttonText}` })} ` })} </div>`} </div> ` })} </div> </div> </div> </section>`;
}, "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/sections/CTA.astro", void 0);
...
}, "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/components/custom/LegacyFeatureCard.astro", void 0);
...
}, "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/pages/index.astro", void 0);

const $$file = "/Users/adamking/claude-code-projects/genzen_solutions_site/genzen-solutions-main/src/pages/index.astro";
const $$url = "";
